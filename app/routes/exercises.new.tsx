...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  const exercise = await createExercise({ name, scheme, force, equipment, mechanic, target: null });
    ...
    <div>
      ...
      >
        <div>
          ...
          <label className="flex w-full flex-col gap-1">
            <span>Equipment: </span>
            <select ref={equipmentRef} name="equipment" className="border border-gray-300 rounded px-4 py-2">
          ...
          <label className="flex w-full flex-col gap-1">
            <span>Mechanic: </span>
            <select ref={mechanicRef} name="mechanic" className="border border-gray-300 rounded px-4 py-2">
        ...
        <button
          type="submit"
          className="rounded bg-slate-600 px-4 py-2 text-blue-100 hover:bg-blue-500 active:bg-blue-600">Create</button>
      </Form>
    </div>
  )
}
