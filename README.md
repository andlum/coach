...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create coach-b69b
  fly apps create coach-b69b-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app coach-b69b
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app coach-b69b-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'coach-b69b-staging' does not match app name in config file 'coach-b69b'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name coach-b69b-db
  fly postgres attach --app coach-b69b coach-b69b-db

  fly postgres create --name coach-b69b-staging-db
  fly postgres attach --app coach-b69b-staging coach-b69b-staging-db
  ```
